...
export function loadPaidMarks(
  storage: Pick<PaidMarksStorage, "getItem">,
): PaidMarks {
  try {
...
export function savePaidMarks(
  storage: Pick<PaidMarksStorage, "setItem">,
  marks: PaidMarks,
): void {
